...
pub mod pallet {
    ...
    pub fn __type_value_for_get_default_value() -> KittyIndex { 0_u32 }
                    ...
                    ::core::result::Result::Ok(Kitty({
                                ...
                                match __codec_res_edqy {
                                    ::core::result::Result::Err(e) =>
                                        return ::core::result::Result::Err(e.chain("Could not decode `Kitty.0`")),
    ...
    impl ::core::cmp::PartialEq for Kitty {
        #[inline]
        fn eq(&self, other: &Kitty) -> bool { self.0 == other.0 }
    }
    ...
    impl ::core::fmt::Debug for Kitty {
        fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
            ::core::fmt::Formatter::debug_tuple_field1_finish(f, "Kitty",
                &&self.0)
        }
    }
    ...
    const _: () =
        {
            impl ::scale_info::TypeInfo for Kitty {
                ...
                fn type_info() -> ::scale_info::Type {
                    ::scale_info::Type::builder().path(::scale_info::Path::new("Kitty",
                                        "pallet_kitties::pallet")).type_params(
                                ...
                                ::alloc::vec::Vec::new()).docs(&[]).composite(::scale_info::build::Fields::unnamed().field(|f|
                                f.ty::<[u8; 16]>().type_name("[u8; 16]").docs(&[])))
                }
            }
            ;
        };
    ...
    pub type NextKittyId<T> =
        StorageValue<_GeneratedPrefixForStorageNextKittyId<T>, KittyIndex,
        ValueQuery, GetDefaultValue>;
    #[allow(type_alias_bounds)]
    pub type Kitties<T> =
        StorageMap<_GeneratedPrefixForStorageKitties<T>, Blake2_128Concat,
        KittyIndex, Kitty>;
    #[allow(type_alias_bounds)]
    pub type KittyOwner<T: Config> =
        StorageMap<_GeneratedPrefixForStorageKittyOwner<T>, Blake2_128Concat,
        KittyIndex, T::AccountId>;
    #[doc =
    r"
    ...
    const _: () =
        {
            impl<T: Config> core::clone::Clone for Event<T> {
                fn clone(&self) -> Self {
                    match self {
                        Self::KittyCreated(ref _0, ref _1, ref _2) =>
                            Self::KittyCreated(core::clone::Clone::clone(_0),
                                core::clone::Clone::clone(_1),
                                core::clone::Clone::clone(_2)),
                        Self::KittyBreed(ref _0, ref _1, ref _2) =>
                            Self::KittyBreed(core::clone::Clone::clone(_0),
                                core::clone::Clone::clone(_1),
                                core::clone::Clone::clone(_2)),
                        Self::KittyTransfered(ref _0, ref _1, ref _2) =>
                            Self::KittyTransfered(core::clone::Clone::clone(_0),
                                core::clone::Clone::clone(_1),
                                core::clone::Clone::clone(_2)),
            ...
            impl<T: Config> core::cmp::PartialEq for Event<T> {
                fn eq(&self, other: &Self) -> bool {
                    match (self, other) {
                        ...
                        (Self::KittyBreed(_0, _1, _2),
                            Self::KittyBreed(_0_other, _1_other, _2_other)) =>
                            true && _0 == _0_other && _1 == _1_other && _2 == _2_other,
                        (Self::KittyTransfered(_0, _1, _2),
                            Self::KittyTransfered(_0_other, _1_other, _2_other)) =>
                            true && _0 == _0_other && _1 == _1_other && _2 == _2_other,
                        (Self::__Ignore(_0, _1), Self::__Ignore(_0_other, _1_other))
                            => true && _0 == _0_other && _1 == _1_other,
                        (Self::KittyCreated { .. }, Self::KittyBreed { .. }) =>
                            false,
                        (Self::KittyCreated { .. }, Self::KittyTransfered { .. }) =>
                            false,
                        (Self::KittyCreated { .. }, Self::__Ignore { .. }) => false,
                        (Self::KittyBreed { .. }, Self::KittyCreated { .. }) =>
                            false,
                        (Self::KittyBreed { .. }, Self::KittyTransfered { .. }) =>
                            false,
                        (Self::KittyBreed { .. }, Self::__Ignore { .. }) => false,
                        (Self::KittyTransfered { .. }, Self::KittyCreated { .. }) =>
                            false,
                        (Self::KittyTransfered { .. }, Self::KittyBreed { .. }) =>
                            false,
                        (Self::KittyTransfered { .. }, Self::__Ignore { .. }) =>
                            false,
                        (Self::__Ignore { .. }, Self::KittyCreated { .. }) => false,
                        (Self::__Ignore { .. }, Self::KittyBreed { .. }) => false,
                        (Self::__Ignore { .. }, Self::KittyTransfered { .. }) =>
                            false,
                    }
                }
            }
    ...
    const _: () =
        {
            impl<T: Config> core::fmt::Debug for Event<T> {
                fn fmt(&self, fmt: &mut core::fmt::Formatter)
                    ...
                    match *self {
                        Self::KittyCreated(ref _0, ref _1, ref _2) => {
                            fmt.debug_tuple("Event::KittyCreated").field(&_0).field(&_1).field(&_2).finish()
                        }
                        Self::KittyBreed(ref _0, ref _1, ref _2) => {
                            fmt.debug_tuple("Event::KittyBreed").field(&_0).field(&_1).field(&_2).finish()
                        }
                        Self::KittyTransfered(ref _0, ref _1, ref _2) => {
                            fmt.debug_tuple("Event::KittyTransfered").field(&_0).field(&_1).field(&_2).finish()
                        }
                        Self::__Ignore(ref _0, ref _1) => {
            ...
            impl<T: Config> ::codec::Encode for Event<T> where
                ...
                fn encode_to<__CodecOutputEdqy: ::codec::Output +
                    ...
                    match *self {
                        ...
                        Event::KittyBreed(ref aa, ref ba, ref ca) => {
                        ...
                        Event::KittyTransfered(ref aa, ref ba, ref ca) => {
                    ...
                    match __codec_input_edqy.read_byte().map_err(|e|
                        ...
                        __codec_x_edqy if
                            ...
                            ::core::result::Result::Ok(Event::<T>::KittyCreated({
                                        ...
                                        match __codec_res_edqy {
                                            ::core::result::Result::Err(e) =>
                                                return ::core::result::Result::Err(e.chain("Could not decode `Event::KittyCreated.0`")),
                                            ::core::result::Result::Ok(__codec_res_edqy) =>
                                                __codec_res_edqy,
                                        }
                                    },
                                    {
                                        ...
                                        match __codec_res_edqy {
                                            ::core::result::Result::Err(e) =>
                                                return ::core::result::Result::Err(e.chain("Could not decode `Event::KittyCreated.1`")),
                                            ::core::result::Result::Ok(__codec_res_edqy) =>
                                                __codec_res_edqy,
                                        }
                                    },
                                    {
                                        ...
                                        match __codec_res_edqy {
                                            ::core::result::Result::Err(e) =>
                                                return ::core::result::Result::Err(e.chain("Could not decode `Event::KittyCreated.2`")),
                                            ::core::result::Result::Ok(__codec_res_edqy) =>
                                                __codec_res_edqy,
                                        }
                                    }))
                        ...
                        __codec_x_edqy if
                            ...
                            ::core::result::Result::Ok(Event::<T>::KittyBreed({
                                        let __codec_res_edqy =
                                            <T::AccountId as
                                                    ::codec::Decode>::decode(__codec_input_edqy);
                                        match __codec_res_edqy {
                                            ::core::result::Result::Err(e) =>
                                                return ::core::result::Result::Err(e.chain("Could not decode `Event::KittyBreed.0`")),
                                            ::core::result::Result::Ok(__codec_res_edqy) =>
                                                __codec_res_edqy,
                                        }
                                    },
                                    {
                                        ...
                                        match __codec_res_edqy {
                                            ::core::result::Result::Err(e) =>
                                                return ::core::result::Result::Err(e.chain("Could not decode `Event::KittyBreed.1`")),
                                            ::core::result::Result::Ok(__codec_res_edqy) =>
                                                __codec_res_edqy,
                                        }
                                    },
                                    {
                                        ...
                                        match __codec_res_edqy {
                                            ::core::result::Result::Err(e) =>
                                                return ::core::result::Result::Err(e.chain("Could not decode `Event::KittyBreed.2`")),
                                            ::core::result::Result::Ok(__codec_res_edqy) =>
                                                __codec_res_edqy,
                                        }
                                    }))
                        ...
                        __codec_x_edqy if
                            ...
                            ::core::result::Result::Ok(Event::<T>::KittyTransfered({
                                        let __codec_res_edqy =
                                            <T::AccountId as
                                                    ::codec::Decode>::decode(__codec_input_edqy);
                                        match __codec_res_edqy {
                                            ::core::result::Result::Err(e) =>
                                                return ::core::result::Result::Err(e.chain("Could not decode `Event::KittyTransfered.0`")),
                                            ::core::result::Result::Ok(__codec_res_edqy) =>
                                                __codec_res_edqy,
                                        }
                                    },
                                    {
                                        ...
                                        match __codec_res_edqy {
                                            ::core::result::Result::Err(e) =>
                                                return ::core::result::Result::Err(e.chain("Could not decode `Event::KittyTransfered.1`")),
                                            ::core::result::Result::Ok(__codec_res_edqy) =>
                                                __codec_res_edqy,
                                        }
                                    },
                                    {
                                        ...
                                        match __codec_res_edqy {
                                            ::core::result::Result::Err(e) =>
                                                return ::core::result::Result::Err(e.chain("Could not decode `Event::KittyTransfered.2`")),
                                            ::core::result::Result::Ok(__codec_res_edqy) =>
                                                __codec_res_edqy,
                                        }
                                    }))
            ...
            impl<T: Config> ::scale_info::TypeInfo for Event<T> where
                ...
                fn type_info() -> ::scale_info::Type {
                    ::scale_info::Type::builder().path(::scale_info::Path::new("Event",
                                        "pallet_kitties::pallet")).type_params(<[_]>::into_vec(#[rustc_box] ::alloc::boxed::Box::new([::scale_info::TypeParameter::new("T",
                                                    ::core::option::Option::None)]))).docs_always(&["\n\t\t\tThe [event](https://docs.substrate.io/v3/runtime/events-and-errors) emitted\n\t\t\tby this pallet.\n\t\t\t"]).variant(::scale_info::build::Variants::new().variant("KittyCreated",
                                    |v|
                                        v.index(0usize as
                                                        ::core::primitive::u8).fields(::scale_info::build::Fields::unnamed().field(|f|
                                                                f.ty::<T::AccountId>().type_name("T::AccountId").docs_always(&[])).field(|f|
                                                            f.ty::<KittyIndex>().type_name("KittyIndex").docs_always(&[])).field(|f|
                                                        f.ty::<Kitty>().type_name("Kitty").docs_always(&[]))).docs_always(&[])).variant("KittyBreed",
                                |v|
                                    v.index(1usize as
                                                    ::core::primitive::u8).fields(::scale_info::build::Fields::unnamed().field(|f|
                                                            f.ty::<T::AccountId>().type_name("T::AccountId").docs_always(&[])).field(|f|
                                                        f.ty::<KittyIndex>().type_name("KittyIndex").docs_always(&[])).field(|f|
                                                    f.ty::<Kitty>().type_name("Kitty").docs_always(&[]))).docs_always(&[])).variant("KittyTransfered",
                            |v|
                                v.index(2usize as
                                                ::core::primitive::u8).fields(::scale_info::build::Fields::unnamed().field(|f|
                                                        f.ty::<T::AccountId>().type_name("T::AccountId").docs_always(&[])).field(|f|
                                                    f.ty::<T::AccountId>().type_name("T::AccountId").docs_always(&[])).field(|f|
                                                f.ty::<KittyIndex>().type_name("KittyIndex").docs_always(&[]))).docs_always(&[])))
                }
            }
            ;
        };
            ...
            impl<T> ::scale_info::TypeInfo for Error<T> where
                ...
                fn type_info() -> ::scale_info::Type {
                    ::scale_info::Type::builder().path(::scale_info::Path::new("Error",
                                        "pallet_kitties::pallet")).type_params(<[_]>::into_vec(#[rustc_box] ::alloc::boxed::Box::new([::scale_info::TypeParameter::new("T",
                                                    ::core::option::Option::None)]))).docs_always(&["\n\t\t\tCustom [dispatch errors](https://docs.substrate.io/v3/runtime/events-and-errors)\n\t\t\tof this pallet.\n\t\t\t"]).variant(::scale_info::build::Variants::new().variant("InvalidKittyId",
                                    |v|
                                        v.index(0usize as
                                                    ::core::primitive::u8).docs_always(&[])).variant("NotOwner",
                                |v|
                                    v.index(1usize as
                                                ::core::primitive::u8).docs_always(&[])).variant("SameKittyId",
                            |v|
                                v.index(2usize as ::core::primitive::u8).docs_always(&[])))
                }
            }
            ;
        };
    ...
    impl<T: Config> Pallet<T> {
        pub fn create(origin: OriginFor<T>) -> DispatchResult {
            ...
            let kitty_id =
                Self::get_next_id().map_err(|_| Error::<T>::InvalidKittyId)?;
        ...
        pub fn breed(origin: OriginFor<T>, kitty_id_1: KittyIndex,
            ...
            let kitty_1 =
                Self::get_kitty(kitty_id_1).map_err(|_|
                            Error::<T>::InvalidKittyId)?;
            let kitty_2 =
                Self::get_kitty(kitty_id_2).map_err(|_|
                            Error::<T>::InvalidKittyId)?;
            let kitty_id =
                Self::get_next_id().map_err(|_| Error::<T>::InvalidKittyId)?;
            ...
            for i in 0..kitty_1.0.len() {
                data[i] =
                    (kitty_1.0[i] & selector[i]) |
                        (kitty_2.0[i] & !selector[i]);
            }
        ...
        pub fn transfer(origin: OriginFor<T>, kitty_id: u32,
            new_owner: T::AccountId) -> DispatchResult {
            let who = ensure_signed(origin)?;
            Self::get_kitty(kitty_id).map_err(|_|
                        Error::<T>::InvalidKittyId)?;
            {
            ...
            Self::deposit_event(Event::KittyTransfered(who, new_owner,
                    kitty_id));
            Ok(())
        }
    }
    impl<T: Config> Pallet<T> {
        fn random_value(sender: &T::AccountId) -> [u8; 16] {
            let payload =
                (T::Randomness::random_seed(), &sender,
            ...
            impl<T: Config> core::fmt::Debug for Call<T> {
                fn fmt(&self, fmt: &mut core::fmt::Formatter)
                    ...
                    match *self {
                        ...
                        Self::create {} => {
                            fmt.debug_struct("Call::create").finish()
                        }
                        Self::breed { ref kitty_id_1, ref kitty_id_2 } => {
                            fmt.debug_struct("Call::breed").field("kitty_id_1",
                                        &kitty_id_1).field("kitty_id_2", &kitty_id_2).finish()
                        }
                        Self::transfer { ref kitty_id, ref new_owner } => {
                            fmt.debug_struct("Call::transfer").field("kitty_id",
                                        &kitty_id).field("new_owner", &new_owner).finish()
                        }
                    }
                }
            }
            ...
            impl<T: Config> core::cmp::PartialEq for Call<T> {
                fn eq(&self, other: &Self) -> bool {
                    match (self, other) {
                        ...
                        (Self::breed { kitty_id_1, kitty_id_2 }, Self::breed {
                            kitty_id_1: _0, kitty_id_2: _1 }) =>
                            true && kitty_id_1 == _0 && kitty_id_2 == _1,
                        (Self::transfer { kitty_id, new_owner }, Self::transfer {
                            kitty_id: _0, new_owner: _1 }) =>
            ...
            impl<T: Config> ::codec::Encode for Call<T> {
                fn encode_to<__CodecOutputEdqy: ::codec::Output +
                    ...
                    match *self {
                        ...
                        Call::transfer { ref kitty_id, ref new_owner } => {
                        ...
                        __codec_x_edqy if
                            ...
                            ::core::result::Result::Ok(Call::<T>::breed {
                                    kitty_id_1: {
                                        ...
                                        match __codec_res_edqy {
                                            ::core::result::Result::Err(e) =>
                                                return ::core::result::Result::Err(e.chain("Could not decode `Call::breed::kitty_id_1`")),
                                            ::core::result::Result::Ok(__codec_res_edqy) =>
                                                __codec_res_edqy,
                                        }
                                    },
                                    kitty_id_2: {
                                        ...
                                        match __codec_res_edqy {
                                            ::core::result::Result::Err(e) =>
                                                return ::core::result::Result::Err(e.chain("Could not decode `Call::breed::kitty_id_2`")),
                                            ::core::result::Result::Ok(__codec_res_edqy) =>
                                                __codec_res_edqy,
                                        }
                                    },
                        ...
                        __codec_x_edqy if
                            ...
                            ::core::result::Result::Ok(Call::<T>::transfer {
                                    kitty_id: {
                                        ...
                                        match __codec_res_edqy {
                                            ::core::result::Result::Err(e) =>
                                                return ::core::result::Result::Err(e.chain("Could not decode `Call::transfer::kitty_id`")),
                                            ::core::result::Result::Ok(__codec_res_edqy) =>
                                                __codec_res_edqy,
                                        }
                                    },
                                    new_owner: {
                                        ...
                                        match __codec_res_edqy {
                                            ::core::result::Result::Err(e) =>
                                                return ::core::result::Result::Err(e.chain("Could not decode `Call::transfer::new_owner`")),
                                            ::core::result::Result::Ok(__codec_res_edqy) =>
                                                __codec_res_edqy,
                                        }
                                    },
    ...
    const _: () =
        {
            impl<T: Config> ::scale_info::TypeInfo for Call<T> where
                frame_support::sp_std::marker::PhantomData<(T,)>: ::scale_info::TypeInfo +
                'static, T::AccountId: ::scale_info::TypeInfo + 'static,
                T: Config + 'static {
                type Identity = Self;
                fn type_info() -> ::scale_info::Type {
                    ::scale_info::Type::builder().path(::scale_info::Path::new("Call",
                                        "pallet_kitties::pallet")).type_params(<[_]>::into_vec(#[rustc_box] ::alloc::boxed::Box::new([::scale_info::TypeParameter::new("T",
                                                    ::core::option::Option::None)]))).docs_always(&["Contains one variant per dispatchable that can be called by an extrinsic."]).variant(::scale_info::build::Variants::new().variant("create",
                                    |v|
                                        v.index(0u8 as
                                                        ::core::primitive::u8).fields(::scale_info::build::Fields::named()).docs_always(&[])).variant("breed",
                                |v|
                                    v.index(1u8 as
                                                    ::core::primitive::u8).fields(::scale_info::build::Fields::named().field(|f|
                                                        f.ty::<KittyIndex>().name("kitty_id_1").type_name("KittyIndex").docs_always(&[])).field(|f|
                                                    f.ty::<KittyIndex>().name("kitty_id_2").type_name("KittyIndex").docs_always(&[]))).docs_always(&[])).variant("transfer",
                            |v|
                                v.index(2u8 as
                                                ::core::primitive::u8).fields(::scale_info::build::Fields::named().field(|f|
                                                    f.ty::<u32>().name("kitty_id").type_name("u32").docs_always(&[])).field(|f|
                                                f.ty::<T::AccountId>().name("new_owner").type_name("T::AccountId").docs_always(&[]))).docs_always(&[])))
                }
            }
            ;
        };
    impl<T: Config> Call<T> {
        ...
        pub fn new_call_variant_create() -> Self { Self::create {} }
        #[doc = "Create a call with the variant `breed`."]
        pub fn new_call_variant_breed(kitty_id_1: KittyIndex,
            kitty_id_2: KittyIndex) -> Self {
            Self::breed { kitty_id_1, kitty_id_2 }
        }
        #[doc = "Create a call with the variant `transfer`."]
        pub fn new_call_variant_transfer(kitty_id: u32,
            new_owner: T::AccountId) -> Self {
            Self::transfer { kitty_id, new_owner }
        }
    }
        ...
        fn get_dispatch_info(&self) -> frame_support::dispatch::DispatchInfo {
            match *self {
                ...
                Self::breed { ref kitty_id_1, ref kitty_id_2 } => {
                    let __pallet_base_weight = 10_000;
                    let __pallet_weight =
                        <dyn frame_support::dispatch::WeighData<(&KittyIndex,
                                &KittyIndex)>>::weigh_data(&__pallet_base_weight,
                            (kitty_id_1, kitty_id_2));
                    let __pallet_class =
                        <dyn frame_support::dispatch::ClassifyDispatch<(&KittyIndex,
                                &KittyIndex)>>::classify_dispatch(&__pallet_base_weight,
                            (kitty_id_1, kitty_id_2));
                    let __pallet_pays_fee =
                        <dyn frame_support::dispatch::PaysFee<(&KittyIndex,
                                &KittyIndex)>>::pays_fee(&__pallet_base_weight,
                            (kitty_id_1, kitty_id_2));
                    frame_support::dispatch::DispatchInfo {
                        weight: __pallet_weight,
                        class: __pallet_class,
                ...
                Self::transfer { ref kitty_id, ref new_owner } => {
                    let __pallet_base_weight = 10_000;
                    let __pallet_weight =
                        <dyn frame_support::dispatch::WeighData<(&u32,
                                &T::AccountId)>>::weigh_data(&__pallet_base_weight,
                            (kitty_id, new_owner));
                    let __pallet_class =
                        <dyn frame_support::dispatch::ClassifyDispatch<(&u32,
                                &T::AccountId)>>::classify_dispatch(&__pallet_base_weight,
                            (kitty_id, new_owner));
                    let __pallet_pays_fee =
                        <dyn frame_support::dispatch::PaysFee<(&u32,
            ...
            match self {
                Self::create {} => {
                                    ...
                                    static META: ::tracing::Metadata<'static> =
                                        {
                                            ::tracing_core::metadata::Metadata::new("create",
                                                "pallet_kitties::pallet", ::tracing::Level::TRACE,
                                                Some("pallets/kitties/src/lib.rs"), Some(12u32),
                    ...
                    frame_support::storage::in_storage_layer(||
                            {
                                <Pallet<T>>::create(origin).map(Into::into).map_err(Into::into)
                            })
                }
                Self::breed { kitty_id_1, kitty_id_2 } => {
                    let __within_span__ =
                            ...
                            static CALLSITE: ::tracing::__macro_support::MacroCallsite =
                                {
                                    ...
                                    static META: ::tracing::Metadata<'static> =
                                        {
                                            ::tracing_core::metadata::Metadata::new("breed",
                                                "pallet_kitties::pallet", ::tracing::Level::TRACE,
                                                Some("pallets/kitties/src/lib.rs"), Some(12u32),
                                                Some("pallet_kitties::pallet"),
                                                ::tracing_core::field::FieldSet::new(&[],
                    ...
                    frame_support::storage::in_storage_layer(||
                            {
                                <Pallet<T>>::breed(origin, kitty_id_1,
                                            kitty_id_2).map(Into::into).map_err(Into::into)
                            })
                }
                Self::transfer { kitty_id, new_owner } => {
                    let __within_span__ =
                            ...
                            static CALLSITE: ::tracing::__macro_support::MacroCallsite =
                                {
                                    ...
                                    static META: ::tracing::Metadata<'static> =
                                        {
                                            ::tracing_core::metadata::Metadata::new("transfer",
                                                "pallet_kitties::pallet", ::tracing::Level::TRACE,
                                                Some("pallets/kitties/src/lib.rs"), Some(12u32),
                                                Some("pallet_kitties::pallet"),
                                                ::tracing_core::field::FieldSet::new(&[],
                    ...
                    frame_support::storage::in_storage_layer(||
                            {
                                <Pallet<T>>::transfer(origin, kitty_id,
                                            new_owner).map(Into::into).map_err(Into::into)
                            })
                }
                Self::__Ignore(_, _) => {
                    let _ = origin;
    ...
    impl<T: Config> Pallet<T> {
        pub fn next_kitty_id() -> KittyIndex {
            <NextKittyId<T> as
                    frame_support::storage::StorageValue<KittyIndex>>::get()
        }
    }
    impl<T: Config> Pallet<T> {
        pub fn kitties<KArg>(k: KArg) -> Option<Kitty> where
            KArg: frame_support::codec::EncodeLike<KittyIndex> {
            <Kitties<T> as
                    frame_support::storage::StorageMap<KittyIndex,
                    Kitty>>::get(k)
        }
    }
    impl<T: Config> Pallet<T> {
        pub fn kitty_owner<KArg>(k: KArg) -> Option<T::AccountId> where
            KArg: frame_support::codec::EncodeLike<KittyIndex> {
            <KittyOwner<T> as
                    frame_support::storage::StorageMap<KittyIndex,
                    T::AccountId>>::get(k)
                            ...
                            frame_support::traits::PalletInfo>::name::<Self>().unwrap_or("<unknown pallet name>");
            {
                ...
                if lvl <= ::log::STATIC_MAX_LEVEL && lvl <= ::log::max_level()
                        ...
                        ::log::__private_api_log(::core::fmt::Arguments::new_v1(&["\u{2705} no migration for "],
                            ...
                            &(frame_support::LOG_TARGET, "pallet_kitties::pallet",
                                    "pallets/kitties/src/lib.rs", 12u32),
    ...
    impl frame_support::traits::Get<KittyIndex> for GetDefaultValue<> {
        fn get() -> KittyIndex { __type_value_for_get_default_value::<>() }
    }
    #[doc(hidden)]
